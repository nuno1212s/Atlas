...
pub struct LTMsg<D: SharedData, OP:OrderingProtocolMessage, SOP: StatefulOrderProtocolMessage>(PhantomData<(D, OP, SOP)>);

impl<D: SharedData, OP:OrderingProtocolMessage, SOP: StatefulOrderProtocolMessage> LogTransferMessage for LTMsg<D, OP, SOP> {
